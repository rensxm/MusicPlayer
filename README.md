...
⚙️ Android Studio-да орнату қадамдары
Жобаны ашу  
...
🚀 Мүмкін болатын жетілдірулер
Эквалайзер (AudioEffect API)

Үстел виджеті (AppWidgetProvider)

Ән мәтіндерін қолдау (LRC-файлдар)

Плейлисттерді бұлтта синхрондау
